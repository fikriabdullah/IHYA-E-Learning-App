...
public class membaca_jilid2  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.membaca_jilid2);
        ...
        bottomNavigation.setOnClickMenuListener(new MeowBottomNavigation.ClickListener() {
            ...
            public void onClickItem(MeowBottomNavigation.Model item) {
                if(item.getId() == 1){
                    ...
                    Intent intent = new Intent(membaca_jilid2.this, home.class);
                    startActivity(intent);
                }else if (item.getId() == 2){
                    Log.d(TAG, "item id : " + item.getId() + "\nStarting Edit Profile");
                    Intent intent = new Intent(membaca_jilid2.this, edit_profile_student.class);
                    startActivity(intent);
                }
